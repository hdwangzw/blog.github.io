    ...
    function(e, t, n) {
        ...
        r.prototype.init = function(e) {
            ...
            try {
                ...
                t.el.innerHTML = '<div class="vwrap"><div class="vheader item' + E.length + '">' + E.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + t.placeholder + '"></textarea><div class="vctrl"><span class="bemoji-btn">BliBiliEmoji</span> | <span class="vemoji-btn">Emoji</span> | <span class="vpreview-btn">Preview</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
                var C = u.find(t.el, ".vempty");
                t.nodata = {
                    show: function(e) {
                        return C.innerHTML = e || t.locale.tips.sofa,
                        u.attr(C, "style", "display:block;"),
                        t
                    },
                    hide: function() {
                        return u.attr(C, "style", "display:none;"),
                        t
                    }
                };
                ...
                t.loading = {
                    show: function(e) {
                        ...
                        return e ? L.insertBefore(M, n[0]) : L.appendChild(M),
                        t.nodata.hide(),
                        t
                    },
                    hide: function() {
                        var e = u.find(L, ".vloading");
                        return e && u.remove(L, e),
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(T, ".vcancel"),
                        function(e) {
                            t.alert.hide()
                    ...
                    hide: function() {
                        return u.attr(T, "style", "display:none;"),
                        t
                    }
                },
                t.bind(e)
        ...
        r.prototype.bind = function(e) {
            ...
            Q = function() {
                ...
                if (h.url = decodeURI(x), h.insertedAt = new Date, R.rid) {
                    ...
                    n.set("rid", R.rid),
                    n.set("pid", r),
                    h.comment = '<a class="at" href="#' + r + '">' + R.at + "</a>" + h.comment
                }
                ...
                n.setACL(U()),
                n.save().then(function(e) {
                    "Anonymous" != h.nick && b && b.setItem("ValineCache", JSON.stringify({
                        nick: h.nick,
                        link: h.link,
                        mail: h.mail
                    }));
    ...
    function(e, t, n) {
        ...
        d = {
            on: function(e, t, n, r) {
                e = e.split(" ");
                for (var i = 0,
                o = e.length; i < o; i++) d.off(e[i], t, n, r),
            ...
            prop: function(e, t, n) {
                return void 0 !== n ? e[t] = n: "[object Object]" !== {}.toString.call(t) ? e[t] : void d.each(t,
                function(t, n) {
                    e[t] = n
                })
            },
            ...
            clearAttr: function(e) {
                ...
                function(t, r) {
                    ...
                    if ("style" === i) {
                        ...
                        d.each(o.split(";"),
                        function(t, n) {
                            if (n.indexOf("color") > -1) return d.attr(e, "style", n),
                            !1;
